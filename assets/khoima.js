...
function update_costs() {
    ...
    shop.active_cost = Math.ceil(tower.base_cost * (tower.cost_multiplier ** shop.active_amount + game.towers[shop.active]))
